                    ...
                    <table className="min-w-full border-collapse bg-white">
                        <thead>
                            <tr className="bg-gray-50 border-b">
                                ...
                                <th className="p-3 text-left font-semibold text-gray-700">Booking Date</th>
                                <th className="p-3 text-left font-semibold text-gray-700">Hours</th>
                                <th className="p-3 text-left font-semibold text-gray-700">Venue</th>
                        ...
                        <tbody>
                            {bookingList.map((booking, index) => (
                                ...
                                >
                                    ...
                                    <td className="p-3">₹{booking.totalCost?.toLocaleString()}</td>
                                    <td className="p-3">
